...
public class DocTest extends BasicTest {
  ...
  public void authentication() throws Exception {
    ...
    client
        .common()
        .deactivateUser("todeactivate", DeactivateUserRequest.builder().build())
        .execute();

    client
        .common()
        .reactivateUser("todeactivate", ReactivateUserRequest.builder().build())
        .execute();
    ...
    var response =
        client
            .common()
            .exportUsers(ExportUsersRequest.builder().userIds(List.of("john")).build())
            .execute();
