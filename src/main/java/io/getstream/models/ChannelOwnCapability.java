...
public class ChannelOwnCapability {
    ...
    public static ChannelOwnCapability BAN_CHANNEL_MEMBERS = new ChannelOwnCapability("ban-channel-members");
    ...
    public static ChannelOwnCapability CREATE_ATTACHMENT = new ChannelOwnCapability("create-attachment");
    public static ChannelOwnCapability DELETE_ANY_MESSAGE = new ChannelOwnCapability("delete-any-message");
    public static ChannelOwnCapability DELETE_CHANNEL = new ChannelOwnCapability("delete-channel");
    public static ChannelOwnCapability DELETE_OWN_MESSAGE = new ChannelOwnCapability("delete-own-message");
    ...
    public static ChannelOwnCapability QUERY_POLL_VOTES = new ChannelOwnCapability("query-poll-votes");
    ...
    public static ChannelOwnCapability SEND_CUSTOM_EVENTS = new ChannelOwnCapability("send-custom-events");
    ...
    public static ChannelOwnCapability SEND_RESTRICTED_VISIBILITY_MESSAGE = new ChannelOwnCapability("send-restricted-visibility-message");
    public static ChannelOwnCapability SEND_TYPING_EVENTS = new ChannelOwnCapability("send-typing-events");
    public static ChannelOwnCapability SET_CHANNEL_COOLDOWN = new ChannelOwnCapability("set-channel-cooldown");
    ...
    public static ChannelOwnCapability UPDATE_ANY_MESSAGE = new ChannelOwnCapability("update-any-message");
    public static ChannelOwnCapability UPDATE_CHANNEL = new ChannelOwnCapability("update-channel");
    public static ChannelOwnCapability UPDATE_CHANNEL_MEMBERS = new ChannelOwnCapability("update-channel-members");
    public static ChannelOwnCapability UPDATE_OWN_MESSAGE = new ChannelOwnCapability("update-own-message");
