...
public class OwnCapability {
    ...
    public static OwnCapability SEND_CLOSED_CAPTIONS_CALL = new OwnCapability("send-closed-captions-call");
    ...
    public static OwnCapability START_INDIVIDUAL_RECORD_CALL = new OwnCapability("start-individual-record-call");
    ...
    public static OwnCapability STOP_INDIVIDUAL_RECORD_CALL = new OwnCapability("stop-individual-record-call");
