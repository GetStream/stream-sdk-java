...
class BaseCall {
    ...
    @NotNull
    public StreamResponse<UpdateCallResponse> update( UpdateCallRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<GetOrCreateCallResponse> getOrCreate( GetOrCreateCallRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<BlockUserResponse> blockUser( BlockUserRequest request) throws StreamException {
        return service.blockUser(this.callType, this.callID, request).execute();
    }
    
    
    @NotNull
    public StreamResponse<SendClosedCaptionResponse> sendClosedCaption( SendClosedCaptionRequest request) throws StreamException {
        return service.sendClosedCaption(this.callType, this.callID, request).execute();
    }
    
    
    @NotNull
    public StreamResponse<DeleteCallResponse> delete( DeleteCallRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<SendCallEventResponse> sendCallEvent( SendCallEventRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<CollectUserFeedbackResponse> collectUserFeedback( CollectUserFeedbackRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<UpdateCallMembersResponse> updateCallMembers( UpdateCallMembersRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<MuteUsersResponse> muteUsers( MuteUsersRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<QueryCallParticipantsResponse> queryCallParticipants( QueryCallParticipantsRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<ListRecordingsResponse> listRecordings( ListRecordingsRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<StartRecordingResponse> startRecording(@NotNull  String recordingType,  StartRecordingRequest request) throws StreamException {
        return service.startRecording(this.callType, this.callID, recordingType, request).execute();
    }
    
        public StreamResponse<StartRecordingResponse> startRecording(@NotNull  String recordingType) throws StreamException {
        return this.startRecording(recordingType,new StartRecordingRequest());
        }
    
    
    @NotNull
    public StreamResponse<StopRecordingResponse> stopRecording(@NotNull  String recordingType,  StopRecordingRequest request) throws StreamException {
        return service.stopRecording(this.callType, this.callID, recordingType, request).execute();
    }
    
        public StreamResponse<StopRecordingResponse> stopRecording(@NotNull  String recordingType) throws StreamException {
        return this.stopRecording(recordingType,new StopRecordingRequest());
        }
    
    
    @NotNull
    public StreamResponse<GetCallReportResponse> getCallReport( GetCallReportRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<StartRTMPBroadcastsResponse> startRTMPBroadcasts( StartRTMPBroadcastsRequest request) throws StreamException {
        return service.startRTMPBroadcasts(this.callType, this.callID, request).execute();
    }
    
    
    @NotNull
    public StreamResponse<StopAllRTMPBroadcastsResponse> stopAllRTMPBroadcasts( StopAllRTMPBroadcastsRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<StopRTMPBroadcastsResponse> stopRTMPBroadcast(@NotNull  String name,  StopRTMPBroadcastRequest request) throws StreamException {
        return service.stopRTMPBroadcast(this.callType, this.callID, name, request).execute();
    }
    
        public StreamResponse<StopRTMPBroadcastsResponse> stopRTMPBroadcast(@NotNull  String name) throws StreamException {
        return this.stopRTMPBroadcast(name,new StopRTMPBroadcastRequest());
        }
    
    
    @NotNull
    public StreamResponse<GetCallParticipantSessionMetricsResponse> getCallParticipantSessionMetrics(@NotNull  String session, @NotNull  String user, @NotNull  String userSession,  GetCallParticipantSessionMetricsRequest request) throws StreamException {
        return service.getCallParticipantSessionMetrics(this.callType, this.callID, session, user, userSession, request).execute();
    }
    
        public StreamResponse<GetCallParticipantSessionMetricsResponse> getCallParticipantSessionMetrics(@NotNull  String session, @NotNull  String user, @NotNull  String userSession) throws StreamException {
        return this.getCallParticipantSessionMetrics(session, user, userSession,new GetCallParticipantSessionMetricsRequest());
        }
    
    
    @NotNull
    public StreamResponse<QueryCallParticipantSessionsResponse> queryCallParticipantSessions(@NotNull  String session,  QueryCallParticipantSessionsRequest request) throws StreamException {
        return service.queryCallParticipantSessions(this.callType, this.callID, session, request).execute();
    }
    
        public StreamResponse<QueryCallParticipantSessionsResponse> queryCallParticipantSessions(@NotNull  String session) throws StreamException {
        return this.queryCallParticipantSessions(session,new QueryCallParticipantSessionsRequest());
        }
    
    
    @NotNull
    public StreamResponse<StartHLSBroadcastingResponse> startHLSBroadcasting( StartHLSBroadcastingRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<StartClosedCaptionsResponse> startClosedCaptions( StartClosedCaptionsRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<StartFrameRecordingResponse> startFrameRecording( StartFrameRecordingRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<StartTranscriptionResponse> startTranscription( StartTranscriptionRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<StopHLSBroadcastingResponse> stopHLSBroadcasting( StopHLSBroadcastingRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<StopClosedCaptionsResponse> stopClosedCaptions( StopClosedCaptionsRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<StopFrameRecordingResponse> stopFrameRecording( StopFrameRecordingRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<StopTranscriptionResponse> stopTranscription( StopTranscriptionRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<ListTranscriptionsResponse> listTranscriptions( ListTranscriptionsRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<UnblockUserResponse> unblockUser( UnblockUserRequest request) throws StreamException {
        return service.unblockUser(this.callType, this.callID, request).execute();
    }
    
    
    @NotNull
    public StreamResponse<UnpinResponse> videoUnpin( VideoUnpinRequest request) throws StreamException {
        return service.videoUnpin(this.callType, this.callID, request).execute();
    }
    
    
    @NotNull
    public StreamResponse<UpdateUserPermissionsResponse> updateUserPermissions( UpdateUserPermissionsRequest request) throws StreamException {
        return service.updateUserPermissions(this.callType, this.callID, request).execute();
    }
    
    
    @NotNull
    public StreamResponse<DeleteRecordingResponse> deleteRecording(@NotNull  String session, @NotNull  String filename,  DeleteRecordingRequest request) throws StreamException {
        return service.deleteRecording(this.callType, this.callID, session, filename, request).execute();
    }
    
        public StreamResponse<DeleteRecordingResponse> deleteRecording(@NotNull  String session, @NotNull  String filename) throws StreamException {
        return this.deleteRecording(session, filename,new DeleteRecordingRequest());
        }
    
    
    @NotNull
    public StreamResponse<DeleteTranscriptionResponse> deleteTranscription(@NotNull  String session, @NotNull  String filename,  DeleteTranscriptionRequest request) throws StreamException {
        return service.deleteTranscription(this.callType, this.callID, session, filename, request).execute();
    }
    
        public StreamResponse<DeleteTranscriptionResponse> deleteTranscription(@NotNull  String session, @NotNull  String filename) throws StreamException {
