...
public class Feed {
    ...
    public StreamResponse<QueryPinnedActivitiesResponse> queryPinnedActivities( QueryPinnedActivitiesRequest request) throws StreamException {
        return service.queryPinnedActivities(this.feedGroup, this.feedID, request).execute();
    }
    
        public StreamResponse<QueryPinnedActivitiesResponse> queryPinnedActivities() throws StreamException {
