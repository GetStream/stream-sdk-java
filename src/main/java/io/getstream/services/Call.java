...
public class Call {
    ...
    @NotNull
    public StreamResponse<StartRecordingResponse> startRecording( StartRecordingRequest request) throws StreamException {
    ...
    @NotNull
    public StreamResponse<StopRecordingResponse> stopRecording( StopRecordingRequest request) throws StreamException {
