...
public class Channel {
    ...
    public StreamResponse<Response> deleteChannelFile( DeleteChannelFileRequest request) throws StreamException {
    ...
    public StreamResponse<UploadChannelFileResponse> uploadChannelFile( UploadChannelFileRequest request) throws StreamException {
    ...
    public StreamResponse<Response> deleteChannelImage( DeleteChannelImageRequest request) throws StreamException {
    ...
    public StreamResponse<UploadChannelResponse> uploadChannelImage( UploadChannelImageRequest request) throws StreamException {
