...
class FeedIntegrationTests {
    ...
    private static void setupEnvironment() throws Exception {
        try {
            ...
            usersMap.put(testUserId, UserRequest.builder()
                .id(testUserId)
                .name("Test User 1")
                .role("user")
                .build());
            usersMap.put(testUserId2, UserRequest.builder()
                .id(testUserId2)
                .name("Test User 2")
                .role("user")
                .build());

            UpdateUsersRequest updateUsersRequest = UpdateUsersRequest.builder()
                .users(usersMap)
                .build();
            ...
            GetOrCreateFeedRequest feedRequest1 = GetOrCreateFeedRequest.builder()
                .userID(testUserId)
                .build();
            GetOrCreateFeedRequest feedRequest2 = GetOrCreateFeedRequest.builder()
                .userID(testUserId2)
                .build();

            GetOrCreateFeedResponse feedResponse1 = feeds.getOrCreateFeed("user", testUserId, feedRequest1)
                .execute().getData();
            GetOrCreateFeedResponse feedResponse2 = feeds.getOrCreateFeed("user", testUserId2, feedRequest2)
                .execute().getData();
    ...
    void test02d_CreateStoryActivityWithExpiration() throws Exception {
        ...
        java.time.Instant tomorrow = java.time.Instant.now().plus(1, java.time.temporal.ChronoUnit.DAYS);
    ...
    void test05_UpdateActivity() throws Exception {
        ...
        UpdateActivityRequest updateRequest = UpdateActivityRequest.builder()
            .text("Updated activity text from Java SDK")
            .userID(testUserId)  // Required for server-side auth
            .custom(customData)
            .build();
        
        UpdateActivityResponse response = feeds.updateActivity(activityId, updateRequest).execute().getData();
    ...
    void test06_AddReaction() throws Exception {
        ...
        AddReactionRequest reactionRequest = AddReactionRequest.builder()
            .type("like")
            .userID(testUserId)
            .build();
        
        AddReactionResponse response = feeds.addReaction(activityId, reactionRequest).execute().getData();
    ...
    void test07_QueryReactions() throws Exception {
        ...
        try {
            ...
            QueryActivityReactionsRequest queryRequest = QueryActivityReactionsRequest.builder()
                .limit(10)
                .filter(filter)
                .build();
            
            QueryActivityReactionsResponse response = feeds.queryActivityReactions(activityId, queryRequest)
                .execute().getData();
    ...
    void test09_QueryComments() throws Exception {
        ...
        QueryCommentsRequest queryRequest = QueryCommentsRequest.builder()
            .filter(filter)
            .limit(10)
            .build();
    ...
    void test10_UpdateComment() throws Exception {
        ...
        String commentId = commentResponse.getComment().getId() != null ? 
            commentResponse.getComment().getId() : "comment-id";
        ...
        UpdateCommentResponse response = feeds.updateComment(commentId, updateRequest).execute().getData();
    ...
    void test11_AddBookmark() throws Exception {
        ...
        try {
            ...
            AddBookmarkRequest bookmarkRequest = AddBookmarkRequest.builder()
                .userID(testUserId)
                .newFolder(AddFolderRequest.builder().name("test-bookmarks1").build())
                .build();
            
            AddBookmarkResponse response = feeds.addBookmark(activityId, bookmarkRequest).execute().getData();
    ...
    void test12_QueryBookmarks() throws Exception {
        ...
        QueryBookmarksRequest request = QueryBookmarksRequest.builder()
            .limit(10)
            .filter(filter)
            .build();
    ...
    void test13_UpdateBookmark() throws Exception {
        ...
        AddBookmarkResponse bookmarkResponse = feeds.addBookmark(activityId, bookmarkRequest).execute().getData();
        String folderID = bookmarkResponse.getBookmark().getFolder().getId();

        // snippet-start: UpdateBookmark
        UpdateBookmarkRequest updateRequest = UpdateBookmarkRequest.builder()
            .folderID(folderID)
            .userID(testUserId)
            .build();
        
        UpdateBookmarkResponse response = feeds.updateBookmark(activityId, updateRequest).execute().getData();
    ...
    void test15_QueryFollows() throws Exception {
        ...
        QueryFollowsRequest request = QueryFollowsRequest.builder()
            .limit(10)
            .build();
    ...
    void test16_UpsertActivities() throws Exception {
        ...
        UpsertActivitiesRequest request = UpsertActivitiesRequest.builder()
    ...
    void test17_PinActivity() throws Exception {
        ...
        PinActivityRequest pinRequest = PinActivityRequest.builder()
            .userID(testUserId)
            .build();
        
        PinActivityResponse response = feeds.pinActivity("user", testUserId, activityId, pinRequest)
            .execute().getData();
    ...
    void test18_UnpinActivity() throws Exception {
        ...
        UnpinActivityRequest unpinRequest = UnpinActivityRequest.builder()
            .UserID(testUserId)
            .build();
        
        UnpinActivityResponse response = feeds.unpinActivity("user", testUserId, activityId, unpinRequest)
            .execute().getData();
    ...
    void test19_DeleteBookmark() throws Exception {
        ...
        DeleteBookmarkResponse response = feeds.deleteBookmark(activityId, deleteRequest).execute().getData();
    ...
    void test20_DeleteReaction() throws Exception {
        ...
        DeleteActivityReactionRequest deleteRequest = DeleteActivityReactionRequest.builder()
            .UserID(testUserId)
            .build();
        
        DeleteActivityReactionResponse response = feeds.deleteActivityReaction(activityId, "like", deleteRequest)
            .execute().getData();
    ...
    void test21_DeleteComment() throws Exception {
        ...
        // snippet-start: DeleteComment
            ...
            DeleteCommentResponse response = feeds.deleteComment(commentId, deleteRequest).execute().getData();
    ...
    void test22_UnfollowUser() throws Exception {
        ...
        try {
            ...
            UnfollowResponse response = feeds.unfollow(
                USER_FEED_TYPE + testUserId,
                USER_FEED_TYPE + testUserId2,
                unfollowRequest
            ).execute().getData();
    ...
    void test23_DeleteActivities() throws Exception {
        ...
        for (String activityId : activitiesToDelete) {
            ...
            DeleteActivityResponse response = feeds.deleteActivity(activityId, deleteRequest).execute().getData();
    ...
    void test24_CreatePoll() throws Exception {
        ...
        try {
            ...
            List<PollOptionInput> options = List.of(
                PollOptionInput.builder().text("Red").build(),
                PollOptionInput.builder().text("Blue").build()
            );

            CreatePollRequest poll = CreatePollRequest.builder()
                .name("Poll")
            ...
            customData.put("poll_description", "Choose your favorite programming language from the options below");
            ...
            AddActivityRequest pollActivity = AddActivityRequest.builder()
                .type("poll")
                .feeds(List.of(testFeedId))
                .pollID(pollId)
                .text(POLL_QUESTION)
        ...
        try {
            ...
            if (!pollOptions.isEmpty()) {
                ...
                try {
                    ...
                    CastPollVoteRequest voteRequest = CastPollVoteRequest.builder()
                        .userID(testUserId)
                        .vote(voteData)
                        .build();
                    
                    PollVoteResponse voteResponse = feeds.castPollVote(activityId, pollId, voteRequest)
                        .execute().getData();
    ...
    void test26_ModerateActivity() throws Exception {
        ...
        try {
            ...
            ActivityFeedbackRequest moderationRequest = ActivityFeedbackRequest.builder()
                .report(true)
                .reason("inappropriate_content")
                .userID(testUserId2) // Different user reporting
                .build();
            
            ActivityFeedbackResponse moderationResponse = feeds.activityFeedback(activityId, moderationRequest)
                .execute().getData();
    ...
    void test27_DeviceManagement() throws Exception {
        ...
        try {
            ...
            CreateDeviceRequest addDeviceRequest = CreateDeviceRequest.builder()
                .id(deviceToken)
                .pushProvider("apn")
                .userID(testUserId)
                .build();
    ...
    void test28_QueryActivitiesWithFilters() throws Exception {
        ...
        try {
            ...
            QueryActivitiesRequest customFilterRequest = QueryActivitiesRequest.builder()
                .limit(10)
                .filter(customFilter)
                .build();
            ...
            QueryActivitiesResponse customFilterResponse = feeds.queryActivities(customFilterRequest).execute().getData();
    ...
    void test29_GetFeedActivitiesWithPagination() throws Exception {
        ...
        QueryActivitiesRequest firstPageRequest = QueryActivitiesRequest.builder()
            .limit(3)
            .filter(filter)
            .build();
        
        QueryActivitiesResponse firstPageResponse = feeds.queryActivities(firstPageRequest).execute().getData();
        ...
        if (nextToken != null) {
            QueryActivitiesRequest secondPageRequest = QueryActivitiesRequest.builder()
                .limit(3)
                .next(nextToken)
                .filter(filter)
                .build();
            
            QueryActivitiesResponse secondPageResponse = feeds.queryActivities(secondPageRequest).execute().getData();
    ...
    void test30_ErrorHandlingScenarios() throws Exception {
        ...
        try {
            ...
            AddActivityRequest emptyActivity = AddActivityRequest.builder()
                .type("post")
                .text("") // Empty text
                .userID(testUserId)
                .feeds(List.of(testFeedId))
        ...
        try {
            ...
            AddActivityRequest invalidUserActivity = AddActivityRequest.builder()
                .type("post")
    ...
    void test31_AuthenticationScenarios() throws Exception {
        ...
        UpdateActivityResponse updateResponse = feeds.updateActivity(activityId, updateRequest).execute().getData();
    ...
    void test32_RealWorldUsageDemo() throws Exception {
        ...
        AddActivityRequest postActivity = AddActivityRequest.builder()
            .type("post")
        ...
        if (!createdActivityIds.isEmpty()) {
            for (String activityId : createdActivityIds) {
                try {
                    ...
                    System.out.println("Warning: Failed to cleanup activity " + activityId + ": " + e.getMessage());
                }
            }
        }
        ...
        if (!createdCommentIds.isEmpty()) {
            for (String commentId : createdCommentIds) {
                try {
                    ...
                    // Ignore cleanup errors
                    System.out.println("Warning: Failed to cleanup comment " + commentId + ": " + e.getMessage());
                }
            }
        }
