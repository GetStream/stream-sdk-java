...
public class WebhookTest {
    ...
    public void testParseWebhookEvent(String eventType, String expectedClassName) throws Webhook.WebhookException {
    ...
    public void testParseWebhookEventUnknownType() {
        assertThrows(Webhook.WebhookException.class, () -> {
